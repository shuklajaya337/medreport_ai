...
export default function Home() {
  ...
  <div className="flex items-center gap-3">
    ...
    <a href="#report-section" className="text-sm font-medium bg-black dark:bg-white text-white dark:text-black px-4 py-2 rounded-full hover:scale-105 transition-transform">
      Get Started
      </a>
      </div>
      </nav>
      ...
      >
        <AuroraBackground>
          <div className="relative flex flex-col gap-6 items-center justify-center px-4 min-h-screen text-center">
            ...
            <p className="font-light text-base md:text-xl text-neutral-800 max-w-xl">
      ...
      {/* Footer */}
      <footer className="border-t border-neutral-200 dark:border-neutral-800 py-8 px-6 bg-white dark:bg-black">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-neutral-400 dark:text-neutral-600">
            © 2026 MedReportAI. For educational use only.
          </p>
        </div>
      </footer>
    </>
